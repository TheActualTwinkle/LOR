...
public class GetClassesQueryHandler(IUnitOfWork unitOfWork, ClassDto classDto)
    : IRequestHandler<GetClassesQuery, Result>
{
    public async Task<Result> Handle(GetClassesQuery request, CancellationToken cancellationToken)
    {
